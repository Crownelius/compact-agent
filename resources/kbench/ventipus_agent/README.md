...
`swe-ci`/`swecibench`, `ci-repair`/`ci-repair-bench`, `roadmapbench`, `saasbench`,
...
task-alignment/spec-compliance/reward-hack/long-horizon risk blocks, including SWE-WebDevBench canary/frontend-backend/security validation signals and SWE-CI evolution/checklist/CI-loop validation signals, decision-observability predictions for edits and validation-reliability evidence
