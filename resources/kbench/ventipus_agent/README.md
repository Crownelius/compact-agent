...
`swe-cycle`/`fullcycle`/`swe-judge`, `swe-ci`/`swecibench`, `swe-prbench`/`prbench`/`pr-review`, `ci-repair`/`ci-repair-bench`, `roadmapbench`, `saasbench`,
