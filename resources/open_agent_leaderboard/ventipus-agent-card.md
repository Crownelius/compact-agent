...
For AHE-style component and decision observability, Ventipus classifies edit targets by changed surface and records explicit regression foresight. Non-trivial benchmark edits should name the component surface and include both `Prediction:` and `At-risk regression:` lines; missing forecasts appear in change evaluation, trajectory quality, process defects, and completion reminders.
