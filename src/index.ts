...
export function handleSlashCommand(
  ...
  switch (cmd) {
    ...
    case '/leaderboard': {
      if (!args) {
        console.log(chalk.yellow('  Usage: /benchmark [auto|swe-bench|terminal-bench|swe-context|swe-chain|ci-repair|wildclaw|arc-agi|specbench|reward-hacking|roadmapbench|saasbench|swe-bench-mobile|appworld|browsecomp|tau2|generic] <task>'));
        return { handled: true };
      }
