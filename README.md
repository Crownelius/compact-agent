...
| `/benchmark <task>` | Run a benchmark-grade issue/terminal workflow. Profiles: `swe-bench`, `terminal-bench`, `swe-context`, `swe-chain`, `ci-repair`, `wildclaw`, `arc-agi`, `specbench`, `reward-hacking`, `generic`. |
